...
<fieldset style = "width: 700px; margin: 0px auto;" class="login_fldset" >
      ...
      <tr>
        <td align="center" width="100%">
          <div id="error_message_01" class="error_div">
            ...
            <?php
            print " ";
            if (isset($_SESSION['s_login_error']) && isset($_SESSION['s_formAttempt'])) {
              print $_SESSION['s_login_error'] . " (by PHP)";
              unset($_SESSION['s_login_error']);
      ...
      <table width="99.9%" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#eeeeee">
        ...
        <tr>
          <td colspan='2' align="center">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="button" name="forgot_pass" id="forgot_pass" value="Esqueci minha senha" onclick="window.location.href='pass_recovery.php'" />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <fieldset style = "width: 500px; margin: 0px auto;" class="msg_fldset">
      <table width="100%" border="0" cellspacing="3" cellpadding="3" align="center">
        <tr>
          <td align="center">
            <?php
            echo "Você esta usando "; ?>
            <font size="2" color="red"><strong><?php echo $ua['name']; ?></strong></font>
            <?php echo " no sistema operacional "; ?>
            <font size="2" color="red"><strong><?php echo $ua['platform']; ?></strong></font><?php echo ".";
            ?>
          </td>
        </tr>
      </table>
  ...
  <fieldset style = "width: 500px; margin: 0px auto;" class="login_fldset">
      <table width="100%" border="0" cellspacing="3" cellpadding="3" align="center">
        <tr>
          <td align="center">
            Este site foi otimizado para utilização em navegadores com a <br />
            linguagem <strong>JavaScript</strong> habilitada.<br /><br />
            Verifique [<a href="http://www.whatismybrowser.com/is-javascript-enabled">aqui<a/>] 
            se seu navegador está com JavaScript habilitada e, caso contrário,<br />
            siga as instruções para habilitá-la e obter o aproveitamento adequado dos recursos<br />
